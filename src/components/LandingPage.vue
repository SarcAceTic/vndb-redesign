      ...
      <v-col>
       ...
       <v-col>
        <v-btn class="mr-5" color="blue-darken-1" elevation="10">
         See Visual Novels
         <template v-slot:append><v-icon>mdi-arrow-right</v-icon></template>
        </v-btn>
     ...
     <v-col cols="12" class="mt-10">
      <v-row class="other-data">
       <v-col cols="" class="text-center">
        <h3>
         <v-icon color="green">mdi-circle-small</v-icon>
         {{ somevn.data.chars.toLocaleString() }}
        </h3>
        <h5>Characters</h5>
       </v-col>
       <v-col cols="" class="text-center">
        <h3>
         <v-icon color="green">mdi-circle-small</v-icon>
         {{ somevn.data.producers.toLocaleString() }}
        </h3>
        <h5>Producers</h5>
       </v-col>
       <v-col cols="" class="text-center">
        <h3>
         <v-icon color="green">mdi-circle-small</v-icon>
         {{ somevn.data.releases.toLocaleString() }}
        </h3>
        <h5>Releases</h5>
       </v-col>
       <v-col cols="" class="text-center">
        <h3>
         <v-icon color="green">mdi-circle-small</v-icon>
         {{ somevn.data.tags.toLocaleString() }}
        </h3>
        <h5>Tags</h5>
       </v-col>
       <v-col cols="" class="text-center">
        <h3>
         <v-icon color="green">mdi-circle-small</v-icon>
         {{ somevn.data.traits.toLocaleString() }}
        </h3>
        <h5>Traits</h5>
       </v-col>
      </v-row>
